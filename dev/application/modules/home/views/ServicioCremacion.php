    ...
    $('#add-form').validate({
        ...
        submitHandler: function(form) {
            ...
            if (confirm("Confirma que desea guardar!") == true) {
                $.ajax({
                type: "POST",
                url: "<?php echo base_url() . "home/AddTramiteServicioCremacion"; ?>",
...
<form class="cform-form form-horizontal"  id="add-form" method="POST">
    ...
    <div class="control-group">
        <label class="control-label" for="inputUsuario">Tramite</label>
		 <div class="controls">
                     <input type="hidden" id="id_bloque" name="id_bloque" value="0" >
			<input type="text" id="tramite" name="tramite" value="Servicio Cremacion"  readonly="true">
		</div>
	</div>   
	...
	<div class="control-group">
        ...
        <div class="controls">
			<select class="form-control" id="tipos" name="tipo">
